/**
 * StudentSchedule - Pagina de horario del alumno
 * Muestra el horario de clases por dia
 */
...
export default function StudentSchedule() {
  ...
  const daySchedules = mockSchedules.filter(s => s.day === selectedDay);
  ...
  const getSubjectColor = (index: number): string => {
    const colors = [
      ...
      'from-pink-50 to-pink-100 border-l-4 border-pink-600',
      'from-indigo-50 to-indigo-100 border-l-4 border-indigo-600',
    ];
    ...
    <ProtectedRoute requiredRole="student">
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Clases de la semana</p>
        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-600 font-medium">Docente</p>
                        <p className="text-lg font-bold text-gray-900">{schedule.teacherName}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {schedule.capacity && (
                    <div className="mt-4 pt-4 border-t border-gray-300/30">
                      <p className="text-xs text-gray-600 font-medium mb-2">Capacidad del aula</p>
                      ...
                      <p className="text-xs text-gray-600 mt-1">22 / 30 estudiantes</p>
                    </div>
                  )}
                </Card>
              ))
        ...
        <Card className="p-6 border-0 shadow-md bg-gradient-to-br from-blue-50 to-blue-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600 mt-2">{mockSchedules.length}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600 mt-2">
                {new Set(mockSchedules.map(s => s.subjectId)).size}
              </p>
            </div>
          </div>
        </Card>
